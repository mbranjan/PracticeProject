...
SUCCESS_MSG = "REPL_DC_LANE table load was successful"

CLUSTER_NAME = "repl-dl-ephe-repl-dc-lane"

REPL_JAR_PATH = "gs://dca-repl-airflow-dag/JARS/"
REPL_FILE_PATH = "gs://dca-repl-airflow-dag/files/"

DAG_NAME = "repl_dc_lane_dag"
DAG_DESC = "REPL DC Lane spark load job"
APP_NAME = "REPL_DC_LANE"
...
SIGNAL_FILE_PATTERN = "Signal_GRS_DC_LANE_*_JWUSR40U.txt"
POLL_PERIOD = "5"
WAIT_PERIOD = "240"

repl_dc_lane_common_event_poll = SSHOperator(
    ...
    dag=repl_dc_lane_load_dag
)

# **************** Oldest File check Task started ******************
repl_dc_lane_oldest_file_check = SSHOperator(
...
OLDEST_FILE = FILE_PATH + "/GRS_DC_LANE_" + DATETIME + "_JWUSR40U*"
...
repl_dc_lane_file_move_to_hdfs = SSHOperator(
...
create_bfdms_dpaas_cluster = BFDMSDataprocCreateClusterOperator(
    ...
    cluster_name=CLUSTER_NAME, dag=repl_dc_lane_load_dag,
...
repl_dc_lane_spark_load_job = DataprocSubmitJobOperator(
    task_id='repl_dc_lane_spark_load_job', job=create_spark_job("REPL_DC_LANE_WMT"),
    gcp_conn_id=CONN_ID, dag=repl_dc_lane_load_dag, trigger_rule='all_success')
...
repl_dc_lane_file_archive_in_hdfs = BashOperator(
...
repl_dc_lane_delete_oldest_file = SSHOperator(
...
TRIG_FILE = FILE_PATH + "/" + GEO_RGN_CD + "_" + SCHEMA_NAME + "_" + TABLE_NAME + "_wmtus_" + DATETIME + ".trig"
...
repl_dc_lane_delete_signal_file = SSHOperator(
...
repl_dc_lane_common_event_poll >> repl_dc_lane_oldest_file_check >> assign_variable >> repl_dc_lane_file_move_to_hdfs >> create_bfdms_dpaas_cluster >> repl_dc_lane_spark_load_job >> delete_cluster
repl_dc_lane_spark_load_job >> repl_dc_lane_file_archive_in_hdfs >> repl_dc_lane_create_trig_file >> repl_dc_lane_delete_oldest_file >> repl_dc_lane_delete_signal_file
