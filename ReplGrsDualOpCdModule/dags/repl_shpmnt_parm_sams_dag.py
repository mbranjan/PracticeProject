...
SUCCESS_MSG = "REPL_SHPMNT_PARM_SAMS Workflow load was successful"

CLUSTER_NAME = "repl-dl-ephe-repl-shpmnt-parm-sams"

REPL_JAR_PATH = "gs://dca-repl-airflow-dag/JARS/"
REPL_FILE_PATH = "gs://dca-repl-airflow-dag/files/"

DAG_NAME = "repl_shpmnt_parm_sams_dag"
DAG_DESC = "REPL shipment parm sams spark load job"
APP_NAME = "REPL_SHPMNT_PARM_SAMS"
...
repl_shpmnt_parm_sams_load_dag = DAG(
    DAG_NAME,
...
SIGNAL_FILE_PATTERN = "Signal_GRS_SHIP_PARM_*_JSUSRB6U.txt"
POLL_PERIOD = "5"
WAIT_PERIOD = "120"

repl_shpmnt_parm_sams_common_event_poll = SSHOperator(
    ...
    dag=repl_shpmnt_parm_sams_load_dag
)

# **************** Oldest File check Task started ******************
repl_shpmnt_parm_sams_oldest_file_check = SSHOperator(
...
OLDEST_FILE = FILE_PATH + "/GRS_SHIP_PARM_" + DATETIME + "_JSUSRB6U*"
...
repl_shpmnt_parm_sams_file_move_to_hdfs = SSHOperator(
...
create_bfdms_dpaas_cluster = BFDMSDataprocCreateClusterOperator(
    ...
    cluster_name=CLUSTER_NAME, dag=repl_shpmnt_parm_sams_load_dag,
...
repl_shpmnt_parm_sams_spark_load_job = DataprocSubmitJobOperator(
    task_id='repl_shpmnt_parm_sams_spark_load_job', job=create_spark_job("REPL_SHPMNT_PARM_SAMS"),
    gcp_conn_id=CONN_ID, dag=repl_shpmnt_parm_sams_load_dag, trigger_rule='all_success')
...
repl_shpmnt_parm_sams_file_archive_in_hdfs = BashOperator(
...
repl_shpmnt_parm_sams_delete_oldest_file = SSHOperator(
...
repl_shpmnt_parm_sams_delete_signal_file = SSHOperator(
...
repl_shpmnt_parm_sams_common_event_poll >> repl_shpmnt_parm_sams_oldest_file_check >> assign_variable >> repl_shpmnt_parm_sams_file_move_to_hdfs >> create_bfdms_dpaas_cluster >> repl_shpmnt_parm_sams_spark_load_job >> delete_cluster
repl_shpmnt_parm_sams_spark_load_job >> repl_shpmnt_parm_sams_file_archive_in_hdfs >> repl_shpmnt_parm_sams_delete_oldest_file >> repl_shpmnt_parm_sams_delete_signal_file
