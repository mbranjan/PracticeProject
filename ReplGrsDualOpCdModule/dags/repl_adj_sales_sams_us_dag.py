...
SUCCESS_MSG = "REPL_ADJ_SALES_SMAS table load was successful"

CLUSTER_NAME = "repl-dl-ephe-repl-adj-sales-sams"
REPL_JAR_PATH = "gs://dca-repl-airflow-dag/JARS/"
REPL_FILE_PATH = "gs://dca-repl-airflow-dag/files/"

DAG_NAME = "repl_adj_sales_sams_dag"
DAG_DESC = "REPL Adj sales spark load job"
APP_NAME = "REPL_ADJ_SALES_SAMS"
...
repl_adj_sales_sams_load_dag = DAG(
    DAG_NAME,
...
SIGNAL_FILE_PATTERN = "Signal_GRS_ADJUSTEDSALES_*_JSS1R11U.txt"
POLL_PERIOD = "5"
WAIT_PERIOD = "120"

repl_adj_sales_sams_common_event_poll = SSHOperator(
    ...
    dag=repl_adj_sales_sams_load_dag
)

# **************** Oldest File check Task started ******************
repl_adj_sales_sams_oldest_file_check = SSHOperator(
...
OLDEST_FILE_DELETE = FILE_PATH + "/GRS_ADJUSTEDSALES_DELETE_" + DATETIME + "_JSS1R11U*"
OLDEST_FILE_UPSERT = FILE_PATH + "/GRS_ADJUSTEDSALES_UPSERT_" + DATETIME + "_JSS1R11U*"
...
COUNTRY_CODE = "us"
OP_CMPNY_CD = "SAMS-US"
SCHEMA_NAME = Variable.get("repl_adj_sales_load_dag_var", deserialize_json=True)["schema_name"]
TABLE_NAME = Variable.get("repl_adj_sales_load_dag_var", deserialize_json=True)["table_name"]
# SCHEMA_NAME = "ww_repl_dl_secure"
# TABLE_NAME = "repl_adj_sales"
TABLE_PATH_UPSERT = TABLE_NAME + "/sams_us/upsert"
TABLE_PATH_DELETE = TABLE_NAME + "/sams_us/delete"

repl_adj_sales_sams_delete_file_move_to_hdfs = SSHOperator(
    task_id="repl_adj_sales_sams_delete_file_move_to_hdfs",
    ssh_hook=sshHook,
    conn_timeout=600, cmd_timeout=600,
...
repl_adj_sales_sams_upsert_file_move_to_hdfs = SSHOperator(
    task_id="repl_adj_sales_sams_upsert_file_move_to_hdfs",
    ssh_hook=sshHook,
    conn_timeout=600, cmd_timeout=600,
...
GCP_LOCATION = GCP_BUCKET + "/user/svcmdsedat/landing/incremental/us/" + SCHEMA_NAME + "/" + TABLE_NAME + "/sams_us/"
# GEO_RGN_CD = "US"

create_bfdms_dpaas_cluster = BFDMSDataprocCreateClusterOperator(
    task_id='create_bfdms_dpaas_cluster',
    cluster_name=CLUSTER_NAME, dag=repl_adj_sales_sams_load_dag,
...
repl_adj_sales_sams_spark_load_job = DataprocSubmitJobOperator(
    task_id='repl_adj_sales_sams_spark_load_job', job=create_spark_job("REPL_ADJ_SALES_SAMS"),
    gcp_conn_id=CONN_ID, dag=repl_adj_sales_sams_load_dag, trigger_rule='all_success')
...
repl_adj_sales_sams_delete_file_archive_in_hdfs = BashOperator(
    task_id="repl_adj_sales_sams_delete_file_archive_in_hdfs",
...
repl_adj_sales_sams_upsert_file_archive_in_hdfs = BashOperator(
    task_id="repl_adj_sales_sams_upsert_file_archive_in_hdfs",
...
repl_adj_sales_sams_delete_oldest_file_delete = SSHOperator(
    task_id="repl_adj_sales_sams_delete_oldest_file_delete",
    ssh_hook=sshHook,
    conn_timeout=600, cmd_timeout=600,
...
repl_adj_sales_sams_delete_oldest_file_upsert = SSHOperator(
    task_id="repl_adj_sales_sams_delete_oldest_file_upsert",
    ssh_hook=sshHook,
    conn_timeout=600, cmd_timeout=600,
...
repl_adj_sales_sams_common_event_poll >> repl_adj_sales_sams_oldest_file_check >> assign_variable >> repl_adj_sales_sams_delete_file_move_to_hdfs >> repl_adj_sales_sams_upsert_file_move_to_hdfs >> create_bfdms_dpaas_cluster >> repl_adj_sales_sams_spark_load_job >> delete_cluster
repl_adj_sales_sams_spark_load_job >> repl_adj_sales_sams_delete_file_archive_in_hdfs >> repl_adj_sales_sams_upsert_file_archive_in_hdfs >> repl_adj_sales_sams_delete_oldest_file_delete >> repl_adj_sales_sams_delete_oldest_file_upsert >> repl_adj_sales_delete_signal_file
