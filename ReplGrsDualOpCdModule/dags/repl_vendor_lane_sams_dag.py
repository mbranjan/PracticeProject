...
SUCCESS_MSG = "REPL_VENDOR_LANE_SAMS table load was successful"
...
DAG_NAME = "repl_vendor_lane_sams_dag"
DAG_DESC = "REPL Vendor Lane Sams spark load job"
APP_NAME = "REPL_VENDOR_LANE_SAMS"
...
repl_vendor_lane_sams_load_dag = DAG(
    DAG_NAME,
...
SIGNAL_FILE_PATTERN = "Signal_GRS_VENDOR_LANE_*_JSS1R41U.txt"
POLL_PERIOD = "5"
WAIT_PERIOD = "120"

repl_vendor_lane_sams_common_event_poll = SSHOperator(
    ...
    dag=repl_vendor_lane_sams_load_dag
)

# **************** Oldest File check Task started ******************
repl_vendor_lane_sams_oldest_file_check = SSHOperator(
...
OLDEST_FILE = FILE_PATH + "/GRS_VENDOR_LANE_" + DATETIME + "_JSS1R41U*"
...
repl_vendor_lane_sams_file_move_to_hdfs = SSHOperator(
...
create_bfdms_dpaas_cluster = BFDMSDataprocCreateClusterOperator(
    ...
    cluster_name=CLUSTER_NAME, dag=repl_vendor_lane_sams_load_dag,
...
repl_vendor_lane_sams_spark_load_job = DataprocSubmitJobOperator(
    task_id='repl_vendor_lane_sams_spark_load_job', job=create_spark_job("REPL_VENDOR_LANE_WMT"),
    gcp_conn_id=CONN_ID, dag=repl_vendor_lane_sams_load_dag, trigger_rule='all_success')
...
repl_vendor_lane_sams_file_archive_in_hdfs = BashOperator(
...
repl_vendor_lane_sams_delete_oldest_file = SSHOperator(
...
repl_vendor_lane_sams_delete_signal_file = SSHOperator(
...
repl_vendor_lane_sams_common_event_poll >> repl_vendor_lane_sams_oldest_file_check >> assign_variable >> repl_vendor_lane_sams_file_move_to_hdfs >> create_bfdms_dpaas_cluster >> repl_vendor_lane_sams_spark_load_job >> delete_cluster
repl_vendor_lane_sams_spark_load_job >> repl_vendor_lane_sams_file_archive_in_hdfs >> repl_vendor_lane_sams_delete_oldest_file >> repl_vendor_lane_sams_delete_signal_file
