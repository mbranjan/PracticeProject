...
SUCCESS_MSG = "REPL_DC_LANE_SAMS table load was successful"

CLUSTER_NAME = "repl-dl-ephe-repl-dc-lane-sams"

REPL_JAR_PATH = "gs://dca-repl-airflow-dag/JARS/"
REPL_FILE_PATH = "gs://dca-repl-airflow-dag/files/"

DAG_NAME = "repl_dc_lane_sams_dag"
DAG_DESC = "REPL DC Lane SAMS spark load job"
APP_NAME = "REPL_DC_LANE_SAMS"
...
repl_dc_lane_sams_load_dag = DAG(
    DAG_NAME,
...
SIGNAL_FILE_PATTERN = "Signal_GRS_DC_LANE_*_JSS1R40U.txt"
POLL_PERIOD = "5"
WAIT_PERIOD = "120"

repl_dc_lane_sams_common_event_poll = SSHOperator(
    ...
    dag=repl_dc_lane_sams_load_dag
)

# **************** Oldest File check Task started ******************
repl_dc_lane_sams_oldest_file_check = SSHOperator(
...
OLDEST_FILE = FILE_PATH + "/GRS_DC_LANE_" + DATETIME + "_JSS1R40U*"
...
COUNTRY_CODE = "us"
SCHEMA_NAME = Variable.get("repl_dc_lane_load_dag_var", deserialize_json=True)["schema_name"]
TABLE_NAME = Variable.get("repl_dc_lane_load_dag_var", deserialize_json=True)["table_name"]
# SCHEMA_NAME = "ww_repl_dl_secure"
# TABLE_NAME = "repl_dc_lane"
GEO_RGN_CD = "us"
OP_CMPNY_CD = "SAMS-US"

TABLE_PATH = TABLE_NAME + "_sams"

repl_dc_lane_sams_file_move_to_hdfs = SSHOperator(
...
create_bfdms_dpaas_cluster = BFDMSDataprocCreateClusterOperator(
    ...
    cluster_name=CLUSTER_NAME, dag=repl_dc_lane_sams_load_dag,
...
repl_dc_lane_sams_spark_load_job = DataprocSubmitJobOperator(
    task_id='repl_dc_lane_sams_spark_load_job', job=create_spark_job("REPL_DC_LANE_SAMS"),
    gcp_conn_id=CONN_ID, dag=repl_dc_lane_sams_load_dag, trigger_rule='all_success')
...
repl_dc_lane_sams_file_archive_in_hdfs = BashOperator(
...
TRIG_FILE = FILE_PATH + "/" + GEO_RGN_CD + "_" + SCHEMA_NAME + "_" + TABLE_NAME + "_samsus_" + DATETIME + ".trig"
trig_command = "rm  " + TRIG_FILE + "; echo 'Creating Trigger file: '; touch  " + TRIG_FILE + "; chmod 777 " + TRIG_FILE + ";"
repl_dc_lane_create_trig_file = SSHOperator(
    task_id="create_trig_file",
    ssh_hook=sshHook,
    conn_timeout=600, cmd_timeout=600,
...
repl_dc_lane_sams_delete_oldest_file = SSHOperator(
...
repl_dc_lane_sams_delete_signal_file = SSHOperator(
...
repl_dc_lane_sams_common_event_poll >> repl_dc_lane_sams_oldest_file_check >> assign_variable >> repl_dc_lane_sams_file_move_to_hdfs >> create_bfdms_dpaas_cluster >> repl_dc_lane_sams_spark_load_job >> delete_cluster
repl_dc_lane_sams_spark_load_job >> repl_dc_lane_sams_file_archive_in_hdfs >> repl_dc_lane_create_trig_file >> repl_dc_lane_sams_delete_oldest_file >> repl_dc_lane_sams_delete_signal_file
