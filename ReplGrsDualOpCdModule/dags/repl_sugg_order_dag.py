...
SUCCESS_MSG = "REPL_SUGG_ORDER table load was successful"

CLUSTER_NAME = "repl-dl-ephe-repl-sugg-order-wmt"

REPL_JAR_PATH = "gs://dca-repl-airflow-dag/JARS/"
REPL_FILE_PATH = "gs://dca-repl-airflow-dag/files/"

DAG_NAME = "repl_sugg_order_dag"
DAG_DESC = "REPL Sugg Order spark load job"
APP_NAME = "REPL_SUGG_ORDER"
...
SIGNAL_FILE_PATTERN = "Signal_GRS_RAW_ORDER_*_JWUSRB5U.txt"
POLL_PERIOD = "5"
WAIT_PERIOD = "120"

repl_sugg_order_common_event_poll = SSHOperator(
    ...
    dag=repl_sugg_order_load_dag
)

# **************** Oldest File check Task started ******************
repl_sugg_order_oldest_file_check = SSHOperator(
...
OLDEST_FILE = FILE_PATH + "/GRS_RAW_ORDER_" + DATETIME + "_JWUSRB5U*"
...
TABLE_PATH = TABLE_NAME + "_us"

repl_sugg_order_file_move_to_hdfs = SSHOperator(
...
create_bfdms_dpaas_cluster = BFDMSDataprocCreateClusterOperator(
    ...
    cluster_name=CLUSTER_NAME, dag=repl_sugg_order_load_dag,
    ...
    return {
        ...
        "spark_job": {
            ...
            "args": ["workflow=" + WORKFLOW_NAME, "runmode=global", "GCP_Location=" + GCP_LOCATION,
                     ...
                     "TABLE_NAME=" + TABLE_NAME, "SCHEMA_NAME=" + SCHEMA_NAME, "partition=200", "run_dq=true",
...
repl_sugg_order_spark_load_job = DataprocSubmitJobOperator(
    task_id='repl_sugg_order_spark_load_job', job=create_spark_job("REPL_SUGG_ORDER_WMT"),
    gcp_conn_id=CONN_ID, dag=repl_sugg_order_load_dag, trigger_rule='all_success')
...
repl_sugg_order_create_trig_file = SSHOperator(
    task_id="repl_sugg_order_create_trig_file",
    ssh_hook=sshHook,
    conn_timeout=600, cmd_timeout=600,
...
repl_sugg_order_delete_oldest_file = SSHOperator(
...
repl_sugg_order_delete_signal_file = SSHOperator(
...
repl_sugg_order_common_event_poll >> repl_sugg_order_oldest_file_check >> assign_variable >> repl_sugg_order_file_move_to_hdfs >> create_bfdms_dpaas_cluster >> repl_sugg_order_spark_load_job >> delete_cluster
repl_sugg_order_spark_load_job >> repl_sugg_order_create_trig_file >> repl_sugg_order_delete_oldest_file >> repl_sugg_order_delete_signal_file
