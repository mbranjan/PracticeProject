...
SUCCESS_MSG = "repl_cal table load was successful"

CLUSTER_NAME = "repl-dl-ephe-repl-filtr-order"

REPL_JAR_PATH = "gs://dca-repl-airflow-dag/JARS/"
REPL_FILE_PATH = "gs://dca-repl-airflow-dag/files/"

DAG_NAME = "repl_filtr_order_dag"
DAG_DESC = "REPL Filtr order spark load job"
APP_NAME = "REPL_FILTR_ORDER"
...
SIGNAL_FILE_PATTERN = "Signal_GRS_FILTERED_ORDER_*_JWUSRB4U.txt"
POLL_PERIOD = "5"
WAIT_PERIOD = "120"

repl_filtr_order_common_event_poll = SSHOperator(
    ...
    dag=repl_filtr_order_load_dag
)

# **************** Oldest File check Task started ******************
repl_filtr_order_oldest_file_check = SSHOperator(
...
OLDEST_FILE = FILE_PATH + "/GRS_FILTERED_ORDER_" + DATETIME + "_JWUSRB4U*"
...
repl_filtr_order_file_move_to_hdfs = SSHOperator(
...
GCP_LOCATION = GCP_BUCKET + "/user/svcmdsedat/landing/incremental/us/" + SCHEMA_NAME + "/" + TABLE_NAME + "_wmtus/"
GEO_RGN_CD = "US"

create_bfdms_dpaas_cluster = BFDMSDataprocCreateClusterOperator(
    task_id='create_bfdms_dpaas_cluster',
    cluster_name=CLUSTER_NAME, dag=repl_filtr_order_load_dag,
    ...
    return {
        ...
        "spark_job": {
            ...
            "args": ["workflow=" + WORKFLOW_NAME, "runmode=global", "GCP_Location=" + GCP_LOCATION,
                     ...
                     "TABLE_NAME=" + TABLE_NAME, "SCHEMA_NAME=" + SCHEMA_NAME, "partition=50", "run_dq=true",
...
repl_filtr_order_spark_load_job = DataprocSubmitJobOperator(
    task_id='repl_filtr_order_spark_load_job', job=create_spark_job("REPL_FILTR_ORDER_WMT"),
    gcp_conn_id=CONN_ID, dag=repl_filtr_order_load_dag, trigger_rule='all_success')
...
repl_filtr_order_file_archive_in_hdfs = BashOperator(
...
repl_filtr_order_delete_oldest_file = SSHOperator(
...
repl_filtr_order_delete_signal_file = SSHOperator(
...
repl_filtr_order_common_event_poll >> repl_filtr_order_oldest_file_check >> assign_variable >> repl_filtr_order_file_move_to_hdfs >> create_bfdms_dpaas_cluster >> repl_filtr_order_spark_load_job >> delete_cluster
repl_filtr_order_spark_load_job >> repl_filtr_order_file_archive_in_hdfs >> repl_filtr_order_delete_oldest_file >> repl_filtr_order_delete_signal_file
