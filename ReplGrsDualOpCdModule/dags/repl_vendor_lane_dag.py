...
SUCCESS_MSG = "REPL_VENDOR_LANE table load was successful"

CLUSTER_NAME = "repl-dl-ephe-repl-vendor-lane"

REPL_JAR_PATH = "gs://dca-repl-airflow-dag/JARS/"
REPL_FILE_PATH = "gs://dca-repl-airflow-dag/files/"

DAG_NAME = "repl_vendor_lane_dag"
DAG_DESC = "REPL Vendor Lane spark load job"
APP_NAME = "REPL_VENDOR_LANE"
...
SIGNAL_FILE_PATTERN = "Signal_GRS_VENDOR_LANE_*_JWUSR41U.txt"
POLL_PERIOD = "5"
WAIT_PERIOD = "360"

repl_vendor_lane_common_event_poll = SSHOperator(
    ...
    dag=repl_vendor_lane_load_dag
)

# **************** Oldest File check Task started ******************

repl_vendor_lane_oldest_file_check = SSHOperator(
...
OLDEST_FILE = FILE_PATH + "/GRS_VENDOR_LANE_" + DATETIME + "_JWUSR41U*"
...
SCHEMA_NAME = Variable.get("repl_vendor_lane_load_dag_var", deserialize_json=True)["schema_name"]
TABLE_NAME = Variable.get("repl_vendor_lane_load_dag_var", deserialize_json=True)["table_name"]
# SCHEMA_NAME = "ww_repl_dl_secure"
# TABLE_NAME = "repl_vendor_lane"

TABLE_PATH = TABLE_NAME + "_wmtus"

repl_vendor_lane_file_move_to_hdfs = SSHOperator(
...
create_bfdms_dpaas_cluster = BFDMSDataprocCreateClusterOperator(
    ...
    cluster_name=CLUSTER_NAME, dag=repl_vendor_lane_load_dag,
    ...
    return {
        ...
        "spark_job": {
            ...
            "args": ["workflow=" + WORKFLOW_NAME, "runmode=global", "GCP_Location=" + GCP_LOCATION,
                     ...
                     "TABLE_NAME=" + TABLE_NAME, "SCHEMA_NAME=" + SCHEMA_NAME, "partition=2", "run_dq=true",
...
repl_vendor_lane_spark_load_job = DataprocSubmitJobOperator(
    task_id='repl_vendor_lane_spark_load_job', job=create_spark_job("REPL_VENDOR_LANE_WMT"),
    gcp_conn_id=CONN_ID, dag=repl_vendor_lane_load_dag, trigger_rule='all_success')
...
repl_vendor_lane_file_archive_in_hdfs = BashOperator(
...
TRIG_FILE = f"{FILE_PATH}/{GEO_RGN_CD}_{SCHEMA_NAME}_{TABLE_NAME}_wmtus_{DATETIME}.trig"
trig_command = "rm  " + TRIG_FILE + "; echo 'Creating Trigger file: '; touch  " + TRIG_FILE + "; chmod 777 " + TRIG_FILE + ";"
repl_vendor_lane_create_trig_file = SSHOperator(
    task_id="repl_vendor_lane_create_trig_file",
    ssh_hook=sshHook,
    conn_timeout=600, cmd_timeout=600,
...
repl_vendor_lane_delete_oldest_file = SSHOperator(
...
repl_vendor_lane_delete_signal_file = SSHOperator(
...
repl_vendor_lane_common_event_poll >> repl_vendor_lane_oldest_file_check >> assign_variable >> repl_vendor_lane_file_move_to_hdfs >> create_bfdms_dpaas_cluster >> repl_vendor_lane_spark_load_job >> delete_cluster
repl_vendor_lane_spark_load_job >> repl_vendor_lane_file_archive_in_hdfs >> repl_vendor_lane_create_trig_file >> repl_vendor_lane_delete_oldest_file >> repl_vendor_lane_delete_signal_file >> repl_sku_fulfmt_parm_common_create_trig_file_distcp
