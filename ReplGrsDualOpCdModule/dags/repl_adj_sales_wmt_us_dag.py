...
SUCCESS_MSG = "REPL_ADJ_SALES table load was successful"

CLUSTER_NAME = "repl-dl-ephe-repl-adj-sales-wmt"
REPL_JAR_PATH = "gs://dca-repl-airflow-dag/JARS/"
REPL_FILE_PATH = "gs://dca-repl-airflow-dag/files/"

DAG_NAME = "repl_adj_sales_dag"
DAG_DESC = "REPL Adj sales spark load job"
APP_NAME = "REPL_ADJ_SALES_WMT_US"
...
SIGNAL_FILE_PATTERN = "Signal_GRS_ADJUSTEDSALES_*_JWUSR11U.txt"
POLL_PERIOD = "5"
WAIT_PERIOD = "240"

repl_adj_sales_common_event_poll = SSHOperator(
    ...
    dag=repl_adj_sales_load_dag
)

# **************** Oldest File check Task started ******************
repl_adj_sales_oldest_file_check = SSHOperator(
...
OLDEST_FILE_DELETE = FILE_PATH + "/GRS_ADJUSTEDSALES_DELETE_" + DATETIME + "_JWUSR11U*"
OLDEST_FILE_UPSERT = FILE_PATH + "/GRS_ADJUSTEDSALES_UPSERT_" + DATETIME + "_JWUSR11U*"
...
COUNTRY_CODE = "us"
OP_CMPNY_CD = "WMT-US"
TABLE_PATH_UPSERT = TABLE_NAME + "/wmt_us/upsert"
TABLE_PATH_DELETE = TABLE_NAME + "/wmt_us/delete"

repl_adj_sales_delete_file_move_to_hdfs = SSHOperator(
    task_id="repl_adj_sales_delete_file_move_to_hdfs",
    ssh_hook=sshHook,
    conn_timeout=600, cmd_timeout=600,
...
repl_adj_sales_upsert_file_move_to_hdfs = SSHOperator(
    task_id="repl_adj_sales_upsert_file_move_to_hdfs",
    ssh_hook=sshHook,
    conn_timeout=600, cmd_timeout=600,
...
GCP_LOCATION = GCP_BUCKET + "/user/svcmdsedat/landing/incremental/us/" + SCHEMA_NAME + "/" + TABLE_NAME + "/wmt_us/"

create_bfdms_dpaas_cluster = BFDMSDataprocCreateClusterOperator(
    task_id='create_bfdms_dpaas_cluster',
    cluster_name=CLUSTER_NAME, dag=repl_adj_sales_load_dag,
...
repl_adj_sales_spark_load_job = DataprocSubmitJobOperator(
    task_id='repl_adj_sales_spark_load_job', job=create_spark_job("REPL_ADJ_SALES_WMT"),
    gcp_conn_id=CONN_ID, dag=repl_adj_sales_load_dag, trigger_rule='all_success')
...
repl_adj_sales_delete_file_archive_in_hdfs = BashOperator(
    task_id="repl_adj_sales_delete_file_archive_in_hdfs",
...
repl_adj_sales_upsert_file_archive_in_hdfs = BashOperator(
    task_id="repl_adj_sales_upsert_file_archive_in_hdfs",
...
repl_adj_sales_delete_oldest_delete_file = SSHOperator(
    task_id="repl_adj_sales_delete_oldest_delete_file",
    ssh_hook=sshHook,
    conn_timeout=600, cmd_timeout=600,
...
repl_adj_sales_delete_oldest_upsert_file = SSHOperator(
    task_id="repl_adj_sales_delete_oldest_upsert_file",
    ssh_hook=sshHook,
    conn_timeout=600, cmd_timeout=600,
...
repl_adj_sales_common_event_poll >> repl_adj_sales_oldest_file_check >> assign_variable >> repl_adj_sales_delete_file_move_to_hdfs >> repl_adj_sales_upsert_file_move_to_hdfs >> create_bfdms_dpaas_cluster >> repl_adj_sales_spark_load_job >> delete_cluster
repl_adj_sales_spark_load_job >> repl_adj_sales_delete_file_archive_in_hdfs >> repl_adj_sales_upsert_file_archive_in_hdfs >> repl_adj_sales_delete_oldest_delete_file >> repl_adj_sales_delete_oldest_upsert_file >> repl_adj_sales_delete_signal_file
