...
CLUSTER_NAME = "repl-dl-ephe-repl-cal"
...
DAG_NAME = FILE_NAME
DAG_DESC = "REPL CAl spark load job"
APP_NAME = "REPL_CAL"
...
SIGNAL_FILE_PATTERN = "Signal_GRS_CAL_*_JWUSRB7U.txt"
POLL_PERIOD = "5"
WAIT_PERIOD = "120"

repl_cal_common_event_poll = SSHOperator(
    ...
    dag=repl_cal_load_dag,
    trigger_rule='all_success'
)

# **************** Oldest File check Task started ******************
repl_cal_oldest_file_check = SSHOperator(
...
OLDEST_FILE = FILE_PATH + "/GRS_CAL_" + DATETIME + "_*"
...
COUNTRY_CODE = "us"
SCHEMA_NAME = Variable.get("repl_cal_load_dag_var", deserialize_json=True)["schema_name"]
TABLE_NAME = Variable.get("repl_cal_load_dag_var", deserialize_json=True)["table_name"]
...
args = ["gcp_location=" + GCP_LOCATION, "src_rcv_dt=" + SRCRCVDT, "table=" + TABLE_NAME, "schema=" + SCHEMA_NAME,
        "src_rcv_ts=" + SRCRCVTS]


# def show_variable(SRCRCV_DT,abc):
#     print("##################################################")
#     print("SRCRCVDT: " + SRCRCV_DT)
#     print("SRC_SIGNAL_FILE_FULL_NAME: " + abc)
#
#
# show_variable = PythonOperator(
#     task_id='show_variable',
#     python_callable=show_variable,
#     op_kwargs={'SRCRCV_DT': SRCRCVDT, 'abc': SRC_SIGNAL_FILE_FULL_NAME},
#     provide_context=True,
#     dag=repl_cal_load_dag,
#     trigger_rule='all_success'
# )

repl_cal_file_move_to_hdfs = SSHOperator(
...
repl_cal_spark_load_job = DCASubmitJobOperator(
    task_id="repl_cal_spark_load_job",
    dag=repl_cal_load_dag,
    region=REGION,
...
repl_cal_delete_oldest_file = SSHOperator(
...
repl_cal_delete_signal_file = SSHOperator(
...
repl_cal_common_event_poll >> repl_cal_oldest_file_check >> assign_variable >>  repl_cal_file_move_to_hdfs >> create_bfdms_dpaas_cluster >> repl_cal_spark_load_job >> repl_cal_file_archive_in_hdfs >> repl_cal_delete_oldest_file >> repl_cal_delete_signal_file
repl_cal_spark_load_job >> delete_cluster
