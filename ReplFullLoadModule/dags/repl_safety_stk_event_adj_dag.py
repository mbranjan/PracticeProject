...
SUCCESS_MSG = "repl_safety_stk_event_adj table load was successful"

CLUSTER_NAME = "repl-dl-ephe-repl-safety-stk-event-adj"
REPL_JAR_PATH = "gs://dca-repl-airflow-dag/JARS/"
REPL_FILE_PATH = "gs://dca-repl-airflow-dag/files/"

DAG_NAME = "repl_safety_stk_event_adj_dag"
DAG_DESC = "repl_safety_stk_event_adj spark load job"
APP_NAME = "repl_safety_stk_event_adj"
...
repl_safety_stk_event_adj_load_dag = DAG(
    DAG_NAME,
...
SIGNAL_FILE_PATTERN = "Signal_SAFETY_STOCK_EVENT_*_JWUSR00U.txt"
POLL_PERIOD = "5"
WAIT_PERIOD = "240"

repl_safety_stk_event_adj_common_event_poll = SSHOperator(
    ...
    dag=repl_safety_stk_event_adj_load_dag,
    trigger_rule='all_success'
)

# **************** Oldest File check Task started ******************

repl_safety_stk_event_adj_oldest_file_check = SSHOperator(
...
OLDEST_FILE = FILE_PATH + "/SAFETY_STOCK_EVENT_" + DATETIME + "_JWUSR00U*"
...
COUNTRY_CODE = "us"
SCHEMA_NAME = Variable.get("repl_safety_stk_event_adj_load_dag", deserialize_json=True)["schema_name"]
TABLE_NAME = Variable.get("repl_safety_stk_event_adj_load_dag", deserialize_json=True)["table_name"]
# SCHEMA_NAME = "ww_repl_dl_secure"
# TABLE_NAME = "repl_safety_stk_event_adj"
SRCRCVDT = "{{ ti.xcom_pull(task_ids='assign_variable', key='SRCRCVDT') }}"
SRCRCVTS = "{{ ti.xcom_pull(task_ids='assign_variable', key='SRCRCVTS') }}"

GCP_LOCATION = LANDING_HDFS_PATH + "/" + LOAD_TYPE + "/" + COUNTRY_CODE + "/" + SCHEMA_NAME + "/" + TABLE_NAME + "/src_rcv_dt"
GEO_RGN_CD = "US"
OP_CMPNY_CD = "WMT-US"
USER_ID = "svcmdsedat"
RUN_MODE = "global"
WF_NAME = "REPL_SAFETY_STK_EVENT_ADJ_WMT"
CRNCY_CD = "USD"

repl_safety_stk_event_adj_file_move_to_hdfs = SSHOperator(
...
def create_spark_job(WORKFLOW_NAME):
    return {
        ...
        "spark_job": {
            "jar_file_uris": [REPL_JAR_PATH + "Repl_Full_Load_Module/ReplFullLoadModule-1.86.jar",
            ...
            "args": ["location=" + GCP_LOCATION, "src_rcv_dt=" + SRCRCVDT, "workflow=" + WORKFLOW_NAME,
                     "schema=" + SCHEMA_NAME, "table=" + TABLE_NAME, "runmode=" + RUN_MODE, "geo_rgn_cd=" + GEO_RGN_CD,
                     "op_cmpny_cd=" + OP_CMPNY_CD, "user_id=" + USER_ID, "src_rcv_ts=" + SRCRCVTS,
                     "crncy_cd=" + CRNCY_CD, "run_dq=true", "enableservices=Dataquality", "env=" + ENV
                     ],
...
repl_safety_stk_event_adj_spark_load_job = DataprocSubmitJobOperator(
    task_id='repl_safety_stk_event_adj_spark_load_job', job=create_spark_job("REPL_SAFETY_STK_EVENT_ADJ_WMT"),
    gcp_conn_id=CONN_ID, dag=repl_safety_stk_event_adj_load_dag, trigger_rule='all_success')
...
repl_safety_stk_event_adj_file_archive_in_hdfs = BashOperator(
...
repl_safety_stk_event_adj_delete_oldest_file = SSHOperator(
...
repl_safety_stk_event_adj_delete_signal_file = SSHOperator(
...
repl_safety_stk_event_adj_common_create_trig_file_distcp = SSHOperator(
...
repl_safety_stk_event_adj_common_event_poll >> repl_safety_stk_event_adj_oldest_file_check >> assign_variable >> repl_safety_stk_event_adj_file_move_to_hdfs >> create_bfdms_dpaas_cluster >> repl_safety_stk_event_adj_spark_load_job >> repl_safety_stk_event_adj_file_archive_in_hdfs >> repl_safety_stk_event_adj_delete_oldest_file >> repl_safety_stk_event_adj_delete_signal_file >> repl_safety_stk_event_adj_common_create_trig_file_distcp
repl_safety_stk_event_adj_spark_load_job >> delete_cluster
