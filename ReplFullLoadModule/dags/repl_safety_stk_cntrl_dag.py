...
SUCCESS_MSG = "repl_safety_stk_cntrl table load was successful"

CLUSTER_NAME = "repl-dl-ephe-repl-safety-stk-cntrl"
REPL_JAR_PATH = "gs://dca-repl-airflow-dag/JARS/"
REPL_FILE_PATH = "gs://dca-repl-airflow-dag/files/"

DAG_NAME = "repl_safety_stk_cntrl_dag"
DAG_DESC = "repl_safety_stk_cntrl spark load job"
APP_NAME = "repl_safety_stk_cntrl"
...
repl_safety_stk_cntrl_load_dag = DAG(
    DAG_NAME,
...
SIGNAL_FILE_PATTERN = "Signal_SAFETY_STOCK_CNTL_*_JWUSR0BU.txt"
POLL_PERIOD = "5"
WAIT_PERIOD = "150"

repl_safety_stk_cntrl_common_event_poll = SSHOperator(
    ...
    dag=repl_safety_stk_cntrl_load_dag,
...
repl_safety_stk_cntrl_oldest_file_check = SSHOperator(
...
OLDEST_FILE = FILE_PATH + "/SAFETY_STOCK_CNTL_" + DATETIME + "_JWUSR0BU*"
...
COUNTRY_CODE = "US"
SCHEMA_NAME = Variable.get("repl_safety_stk_cntrl_load_dag_var", deserialize_json=True)["schema_name"]
TABLE_NAME = Variable.get("repl_safety_stk_cntrl_load_dag_var", deserialize_json=True)["table_name"]
# SCHEMA_NAME = "ww_repl_dl_secure"
# TABLE_NAME = "repl_safety_stk_cntrl"
...
CRNCY_CD = "USD"
REPL_CHNL_MTHD_TXT = "ww_repl_dl_tables.REPL_CHNL_MTHD_TXT"

repl_safety_stk_cntrl_file_move_to_hdfs = SSHOperator(
    ...
    return {
        ...
        "spark_job": {
            ...
            "args": ["location=" + GCP_LOCATION, "src_rcv_dt=" + SRCRCVDT, "workflow=" + WORKFLOW_NAME,
                     ...
                     "crncy_cd=" + CRNCY_CD, "repl_chnl_mthd_txt=" + REPL_CHNL_MTHD_TXT, "run_dq=true",
                     "enableservices=Dataquality", "env=" + ENV
                     ],
...
repl_safety_stk_cntrl_spark_load_job = DataprocSubmitJobOperator(
    task_id='repl_safety_stk_cntrl_spark_load_job', job=create_spark_job("REPL_SAFETY_STK_CNTRL_WMT"),
    gcp_conn_id=CONN_ID, dag=repl_safety_stk_cntrl_load_dag, trigger_rule='all_success')
...
repl_safety_stk_cntrl_file_archive_in_hdfs = BashOperator(
...
repl_safety_stk_cntrl_delete_oldest_file = SSHOperator(
...
repl_safety_stk_cntrl_delete_signal_file = SSHOperator(
...
repl_safety_stk_cntrl_common_create_trig_file_distcp = SSHOperator(
...
repl_safety_stk_cntrl_common_event_poll >> repl_safety_stk_cntrl_oldest_file_check >> assign_variable >> repl_safety_stk_cntrl_file_move_to_hdfs >> create_bfdms_dpaas_cluster >> repl_safety_stk_cntrl_spark_load_job >> repl_safety_stk_cntrl_file_archive_in_hdfs >> repl_safety_stk_cntrl_delete_oldest_file >> repl_safety_stk_cntrl_delete_signal_file >> repl_safety_stk_cntrl_common_create_trig_file_distcp
repl_safety_stk_cntrl_spark_load_job >> delete_cluster
