...
SUCCESS_MSG = "repl_vendor_agmnt_cntrl table load was successful"

CLUSTER_NAME = "repl-dl-ephe-repl-vendor-agmnt-cntrl"
REPL_JAR_PATH = "gs://dca-repl-airflow-dag/JARS/"
REPL_FILE_PATH = "gs://dca-repl-airflow-dag/files/"

DAG_NAME = "repl_vendor_agmnt_cntrl_dag"
DAG_DESC = "repl_vendor_agmnt_cntrl spark load job"
APP_NAME = "repl_vendor_agmnt_cntrl"
...
repl_vendor_agmnt_cntrl_load_dag = DAG(
    DAG_NAME,
...
SIGNAL_FILE_PATTERN = "Signal_GRS_VENDOR_AGREEMENT_*_JWUSR54U.txt"
POLL_PERIOD = "5"
WAIT_PERIOD = "240"

# sh /u/appaorta/aorta/scripts/Aorta_file_poll_check.sh &FILE_PATH# &FILE_PATTERN# &POLL_PERIOD# &WAIT_PERIOD#
repl_vendor_agmnt_cntrl_common_event_poll = SSHOperator(
    ...
    dag=repl_vendor_agmnt_cntrl_load_dag,
...
repl_vendor_agmnt_cntrl_oldest_file_check = SSHOperator(
...
OLDEST_FILE = FILE_PATH + "/GRS_VENDOR_AGREEMENT_" + DATETIME + "_JWUSR54U.txt"
...
# TABLE_NAME = "repl_vendor_agmnt_cntrl"
SCHEMA_NAME = Variable.get("repl_vendor_agmnt_cntrl_load_dag_var", deserialize_json=True)["schema_name"]
TABLE_NAME = Variable.get("repl_vendor_agmnt_cntrl_load_dag_var", deserialize_json=True)["table_name"]
...
repl_vendor_agmnt_cntrl_file_move_to_hdfs = SSHOperator(
...
create_bfdms_dpaas_cluster = BFDMSDataprocCreateClusterOperator(
    ...
    cluster_name=CLUSTER_NAME, dag=repl_vendor_agmnt_cntrl_load_dag,
...
def create_spark_job(WORKFLOW_NAME):
    return {
        ...
        "spark_job": {
            ...
            "args": ["env=" + ENV, "workflow=" + WORKFLOW_NAME, "gcp_location=" + GCP_LOCATION,
                     "src_rcv_dt=" + SRCRCVDT, "table=" + TABLE_NAME, "schema=" + SCHEMA_NAME, "src_rcv_ts=" + SRCRCVTS,
                     "runmode=" + RUN_MODE, "run_dq=true", "enableservices=Dataquality"
                     ],
...
repl_vendor_agmnt_cntrl_spark_load_job = DataprocSubmitJobOperator(
    task_id='repl_vendor_agmnt_cntrl_spark_load_job', job=create_spark_job("REPL_VENDOR_AGMNT_CNTRL"),
    gcp_conn_id=CONN_ID, dag=repl_vendor_agmnt_cntrl_load_dag, trigger_rule='all_success')
...
repl_vendor_agmnt_cntrl_file_archive_in_hdfs = BashOperator(
...
repl_vendor_agmnt_cntrl_delete_oldest_file = SSHOperator(
...
repl_vendor_agmnt_cntrl_delete_signal_file = SSHOperator(
...
repl_vendor_agmnt_cntrl_common_create_trig_file_distcp = SSHOperator(
...
repl_vendor_agmnt_cntrl_common_event_poll >> repl_vendor_agmnt_cntrl_oldest_file_check >> assign_variable >> repl_vendor_agmnt_cntrl_file_move_to_hdfs >> create_bfdms_dpaas_cluster >> repl_vendor_agmnt_cntrl_spark_load_job >> repl_vendor_agmnt_cntrl_file_archive_in_hdfs >> repl_vendor_agmnt_cntrl_delete_oldest_file >> repl_vendor_agmnt_cntrl_delete_signal_file >> repl_vendor_agmnt_cntrl_common_create_trig_file_distcp
repl_vendor_agmnt_cntrl_spark_load_job >> delete_cluster
