...
CLUSTER_NAME = "repl-dl-ephe-repl-prime-item-chng-log"

SCHEMA_NAME = Variable.get("repl_prime_item_chng_log_dag_var", deserialize_json=True)["schema_name"]
TABLE_NAME = Variable.get("repl_prime_item_chng_log_dag_var", deserialize_json=True)["table_name"]
# SCHEMA_NAME = "ww_repl_dl_secure"
# TABLE_NAME = "repl_prime_item_chng_log"
# SCHEMA_NAME = "stg_ww_repl_dl_secure"
# TABLE_NAME = "repl_prime_item_chng_log_test2"
REPL_JAR_PATH = "gs://dca-repl-airflow-dag/JARS/"
REPL_FILE_PATH = "gs://dca-repl-airflow-dag/files/"

DAG_NAME = "repl_prime_item_chng_log_dag"
DAG_DESC = "repl_prime_item_chng_log table load job"
APP_NAME = "repl_prime_item_chng_log"
SUCCESS_MSG = "repl_prime_item_chng_log table load was successful"
...
repl_prime_item_chng_log_load_dag = DAG(
    DAG_NAME,
...
create_bfdms_dpaas_cluster = BFDMSDataprocCreateClusterOperator(
    ...
    cluster_name=CLUSTER_NAME, dag=repl_prime_item_chng_log_load_dag,
...
read_db2_credential = BashOperator(
    ...
    dag=repl_prime_item_chng_log_load_dag,
...
# EMAIL_ID = "mdsealert@email.wal-mart.com"
# LOAD_NAME = "ReplDCSecurePrimeItem"

# USER_ID = "svcmdsedat"

# GCP_LOCATION = "gs://d44d65161c7aa338e992de5105bdae5790ad263e56accf675683dbd507f1bd/user/svcmdsedat/landing/incremental/us/ww_repl_dl_secure/repl_prime_item_chng_log/src_rcv_dt"
...
QUERY = "(SELECT OLD_PRIME_ITEM_NBR,NEW_PRIME_ITEM_NBR,CHANGE_EFFECT_DATE,CHANGE_EFFECT_TIME,CHANGE_STATUS_CD FROM DPMDS003.PRIME_ITM_CHG_LOG)"
...
def create_spark_job(WORKFLOW_NAME):
    return {
        ...
        "spark_job": {
            ...
            "args": ["workflow=" + WORKFLOW_NAME, "runmode=global", "TABLE_NAME=" + TABLE_NAME, "SRCRCVDT=" + SRCRCVDT,
                     "SCHEMA_NAME=" + SCHEMA_NAME, "GCP_Location=" + GCP_LOCATION, "runtype=standalone",
                     "run_dq=true", "enableservices=DATAQUALITY,AUDIT", "env=" + ENV,
                     ...
                     "url=" + URL, "driver=" + DRIVER, "SourceType=DB2", "query=" + QUERY, "numPartitions=40",
                     "partitionColumn=OLD_PRIME_ITEM_NBR"
                     ],
...
repl_prime_item_chng_log_spark_load_job = DataprocSubmitJobOperator(
    task_id='repl_prime_item_chng_log_spark_load_job', job=create_spark_job("ReplPrimeItemChngLogWF"),
    gcp_conn_id=CONN_ID, dag=repl_prime_item_chng_log_load_dag, trigger_rule='all_success')
...
repl_prime_item_chng_log_file_archive_in_hdfs = BashOperator(
...
create_bfdms_dpaas_cluster >> read_db2_credential >> parse_output >> repl_prime_item_chng_log_spark_load_job >> repl_prime_item_chng_log_file_archive_in_hdfs
repl_prime_item_chng_log_spark_load_job >> delete_cluster
